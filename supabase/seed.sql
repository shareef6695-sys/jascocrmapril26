...
INSERT INTO public.companies (
  ...
  -- Parent / Holding
  (
    'c0000000-0000-0000-0000-0000000000001',
    'Imdadat Al Jazera',
  ...
  -- Operating — PVC
  (
    'c0000000-0000-0000-0000-0000000000002',
    'Jasco PVC',
  ...
  -- Operating — Steel
  (
    'c0000000-0000-0000-0000-0000000000003',
    'JASCO Steels',
...
INSERT INTO public.users (
  ...
  (
    ...
    '00000000-0000-0000-0000-000000000001', NULL, 'All Companies',
    '2019-06-01', true
  ),
  ...
  (
    ...
    '00000000-0000-0000-0000-000000000002', NULL, 'Riyadh & Central Region',
    '2021-02-01', true
  ),
...
INSERT INTO public.uom_types (id, company_id, value, label, sort_order, is_active) VALUES
  ('a4000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-0000000000002', 'TO',  'Tonne',       1, true),
  ('a4000000-0000-0000-0000-000000000002', 'c0000000-0000-0000-0000-0000000000002', 'PC',  'Pieces',      2, true),
  ('a4000000-0000-0000-0000-000000000003', 'c0000000-0000-0000-0000-0000000000002', 'KG',  'Kilogram',    3, true),
  ('a4000000-0000-0000-0000-000000000004', 'c0000000-0000-0000-0000-0000000000002', 'M',   'Meter',       4, true),
  ('a4000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-0000000000002', 'ROL', 'Roll',        5, true),
  ('a4000000-0000-0000-0000-000000000006', 'c0000000-0000-0000-0000-0000000000002', 'BAG', 'Bag (25 kg)', 6, true)
...
INSERT INTO public.products (
  ...
  (
    ...
    'e0000000-0000-0000-0000-000000000001', 'a4000000-0000-0000-0000-000000000001',
  ...
  (
    ...
    'e0000000-0000-0000-0000-000000000002', 'a4000000-0000-0000-0000-000000000001',
  ...
  (
    'a9000000-0000-0000-0000-000000000017',
    'c0000000-0000-0000-0000-0000000000002',
  ...
  (
    'a9000000-0000-0000-0000-000000000018',
    'c0000000-0000-0000-0000-0000000000002',
...
INSERT INTO public.contacts (
  ...
  (
    ...
    'qualified', 'referral', '00000000-0000-0000-0000-000000000005',
  ...
  (
    ...
    'negotiation', 'linkedin', '00000000-0000-0000-0000-000000000005',
    'Jubail', 'Saudi Arabia',
  ...
  (
    ...
    'proposal', 'cold_call', '00000000-0000-0000-0000-000000000006',
    'Riyadh', 'Saudi Arabia',
  ...
  (
    ...
    'negotiation', 'referral', '00000000-0000-0000-0000-000000000006',
    'Riyadh', 'Saudi Arabia',
  ...
  (
    ...
    'qualified', 'event', '00000000-0000-0000-0000-000000000005',
    'Jubail', 'Saudi Arabia',
  ...
  (
    ...
    'proposal', 'linkedin', '00000000-0000-0000-0000-000000000006',
    'Riyadh', 'Saudi Arabia',
  ...
  (
    ...
    'proposal', 'website', '00000000-0000-0000-0000-000000000006',
    'Dammam', 'Saudi Arabia',
  ...
  (
    ...
    'qualified', 'cold_call', '00000000-0000-0000-0000-000000000005',
    'Riyadh', 'Saudi Arabia',
  ...
  (
    ...
    'proposal', 'referral', '00000000-0000-0000-0000-000000000006',
    'Dammam', 'Saudi Arabia',
  ...
  (
    ...
    'contacted', 'email', '00000000-0000-0000-0000-000000000005',
    'Jeddah', 'Saudi Arabia',
  ...
  (
    ...
    'qualified', 'linkedin', '00000000-0000-0000-0000-000000000006',
    'Riyadh', 'Saudi Arabia',
  ...
  (
    ...
    'new', 'referral', '00000000-0000-0000-0000-000000000005',
    'Riyadh', 'Saudi Arabia',
  ...
  (
    ...
    'qualified', 'event', '00000000-0000-0000-0000-000000000006',
    'Riyadh', 'Saudi Arabia',
  ...
  (
    ...
    'contacted', 'website', '00000000-0000-0000-0000-000000000005',
    'Riyadh', 'Saudi Arabia',
...
INSERT INTO public.tasks (
  ...
  (
    '4a000000-0000-0000-0000-000000000010',
    'c0000000-0000-0000-0000-0000000000002',
  ...
  (
    '4a000000-0000-0000-0000-000000000011',
    'c0000000-0000-0000-0000-0000000000002',
  ...
  (
    '4a000000-0000-0000-0000-000000000012',
    'c0000000-0000-0000-0000-0000000000002',
  ...
  (
    '4a000000-0000-0000-0000-000000000013',
    'c0000000-0000-0000-0000-0000000000002',
  ...
  (
    '4a000000-0000-0000-0000-000000000014',
    'c0000000-0000-0000-0000-0000000000002',
  ...
  (
    '4a000000-0000-0000-0000-000000000015',
    'c0000000-0000-0000-0000-0000000000002',
...
INSERT INTO public.activities (
  ...
  (
    ...
    'b0000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000005',
    '00000000-0000-0000-0000-000000000006',
  ...
  (
    ...
    'b0000000-0000-0000-0000-000000000006', 'd0000000-0000-0000-0000-000000000007',
    '00000000-0000-0000-0000-000000000006',
  ...
  (
    ...
    'b0000000-0000-0000-0000-000000000014', 'd0000000-0000-0000-0000-000000000010',
    '00000000-0000-0000-0000-000000000005',
  ...
  (
    ...
    'b0000000-0000-0000-0000-000000000011', 'd0000000-0000-0000-0000-000000000018',
    '00000000-0000-0000-0000-000000000005',
  ...
  (
    ...
    'b0000000-0000-0000-0000-000000000010', 'd0000000-0000-0000-0000-000000000009',
    '00000000-0000-0000-0000-000000000006',
  ...
  (
    ...
    'b0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000012',
    '00000000-0000-0000-0000-000000000005',
  ...
  (
    ...
    'b0000000-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000006',
    '00000000-0000-0000-0000-000000000005',
  ...
  (
    ...
    'b0000000-0000-0000-0000-000000000012', 'd0000000-0000-0000-0000-000000000013',
    '00000000-0000-0000-0000-000000000006',
  ...
  (
    ...
    'b0000000-0000-0000-0000-000000000013', 'd0000000-0000-0000-0000-000000000015',
    '00000000-0000-0000-0000-000000000005',
...
INSERT INTO public.forecasts (
  ...
  ('f0000000-0000-0000-0000-000000000101','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000003','2026-01-01',9500000,9750250,'SAR','approved','Q1 opened strong. Aramco and SABIC deals closed.'),
  ('f0000000-0000-0000-0000-000000000102','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000003','2026-02-01',10200000,9980000,'SAR','approved','SABIC framework won. SEC deal in pipeline.'),
  ('f0000000-0000-0000-0000-000000000103','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000003','2026-03-01',11000000,10650000,'SAR','approved','APC contract won. Lost Saudi Readymix.'),
  ('f0000000-0000-0000-0000-000000000104','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000003','2026-04-01',12500000,11675000,'SAR','approved','April: SEC + APC partial. Q2 momentum building.'),
  ('f0000000-0000-0000-0000-000000000105','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000003','2026-05-01',13500000,NULL,'SAR','submitted','Expect Tasnee and Al-Rajhi to close this month.'),
  ('f0000000-0000-0000-0000-000000000106','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000003','2026-06-01',15000000,NULL,'SAR','draft','H1 close target. SABIC extension + Zamil expected.'),
  -- Supervisor (Osman)
  ('f0000000-0000-0000-0000-000000000201','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000004','2026-01-01',4200000,4350000,'SAR','approved','Strong Jan — Eastern Province deals closed.'),
  ('f0000000-0000-0000-0000-000000000202','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000004','2026-02-01',4500000,4210000,'SAR','approved',NULL),
  ('f0000000-0000-0000-0000-000000000203','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000004','2026-03-01',4800000,5100000,'SAR','approved','Exceeded target — APC contract contribution.'),
  ('f0000000-0000-0000-0000-000000000204','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000004','2026-04-01',5200000,4930000,'SAR','approved',NULL),
  ('f0000000-0000-0000-0000-000000000205','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000004','2026-05-01',5800000,NULL,'SAR','submitted','Targeting Tasnee close and Zamil proposal.'),
  ('f0000000-0000-0000-0000-000000000206','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000004','2026-06-01',6200000,NULL,'SAR','draft',NULL),
  -- Staff — Amer
  ('f0000000-0000-0000-0000-000000000301','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000005','2026-01-01',2800000,3150000,'SAR','approved','Aramco Q1 close + SABIC contribution.'),
  ('f0000000-0000-0000-0000-000000000302','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000005','2026-02-01',3000000,2870000,'SAR','approved',NULL),
  ('f0000000-0000-0000-0000-000000000303','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000005','2026-03-01',3200000,3050000,'SAR','approved',NULL),
  ('f0000000-0000-0000-0000-000000000304','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000005','2026-04-01',3500000,3420000,'SAR','approved',NULL),
  ('f0000000-0000-0000-0000-000000000305','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000005','2026-05-01',3800000,NULL,'SAR','submitted','Expecting Aramco Q3 + NWC Phase 1 close.'),
  ('f0000000-0000-0000-0000-000000000306','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000005','2026-06-01',4000000,NULL,'SAR','draft',NULL),
  -- Staff — Hazem
  ('f0000000-0000-0000-0000-000000000401','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000006','2026-01-01',2100000,2200000,'SAR','approved',NULL),
  ('f0000000-0000-0000-0000-000000000402','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000006','2026-02-01',2300000,2080000,'SAR','approved',NULL),
  ('f0000000-0000-0000-0000-000000000403','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000006','2026-03-01',2500000,2650000,'SAR','approved','SEC GI pipe deal contribution.'),
  ('f0000000-0000-0000-0000-000000000404','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000006','2026-04-01',2800000,2745000,'SAR','approved',NULL),
  ('f0000000-0000-0000-0000-000000000405','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000006','2026-05-01',3200000,NULL,'SAR','submitted','Targeting Al-Rajhi + Tasnee close.'),
  ('f0000000-0000-0000-0000-000000000406','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000006','2026-06-01',3500000,NULL,'SAR','draft',NULL)
...
INSERT INTO public.kpis (
  ...
  ('b9000000-0000-0000-0000-000000000001','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000003','2026-04-01','Monthly Revenue','12500000','11675000','SAR','completed','93% of target. Strong pipeline heading into May.'),
  ('b9000000-0000-0000-0000-000000000002','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000003','2026-04-01','New Deals Created','8','7','count','completed',NULL),
  ('b9000000-0000-0000-0000-000000000003','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000003','2026-04-01','Win Rate','40','38','percent','completed',NULL),
  ('b9000000-0000-0000-0000-000000000004','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000003','2026-04-01','Pipeline Value','60000000','62350000','SAR','completed','Above target. 4 deals in negotiation.'),
  -- Sales Manager KPIs — May 2026 (in progress)
  ('b9000000-0000-0000-0000-000000000005','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000003','2026-05-01','Monthly Revenue','13500000',NULL,'SAR','in_progress',NULL),
  ('b9000000-0000-0000-0000-000000000006','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000003','2026-05-01','New Deals Created','8',NULL,'count','in_progress',NULL),
  ('b9000000-0000-0000-0000-000000000007','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000003','2026-05-01','Win Rate','42',NULL,'percent','in_progress',NULL),
  -- Amer KPIs — April 2026
  ('b9000000-0000-0000-0000-000000000011','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000005','2026-04-01','Monthly Revenue','3500000','3420000','SAR','completed',NULL),
  ('b9000000-0000-0000-0000-000000000012','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000005','2026-04-01','Calls Made','60','58','count','completed',NULL),
  ('b9000000-0000-0000-0000-000000000013','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000005','2026-04-01','Meetings Held','12','14','count','completed','Exceeded meetings target.'),
  -- Hazem KPIs — April 2026
  ('b9000000-0000-0000-0000-000000000021','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000006','2026-04-01','Monthly Revenue','2800000','2745000','SAR','completed',NULL),
  ('b9000000-0000-0000-0000-000000000022','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000006','2026-04-01','Calls Made','50','52','count','completed',NULL),
  ('b9000000-0000-0000-0000-000000000023','c0000000-0000-0000-0000-0000000000002','00000000-0000-0000-0000-000000000006','2026-04-01','Proposals Sent','6','5','count','completed',NULL)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.client_targets (
  ...
  ('c4000000-0000-0000-0000-000000000001','c0000000-0000-0000-0000-0000000000002','b0000000-0000-0000-0000-000000000001','2026-03-01','00000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000005',1200000,1250000,'SAR','completed','Exceeded. CPVC Q1 order higher than forecast.'),
  ('c4000000-0000-0000-0000-000000000002','c0000000-0000-0000-0000-0000000000002','b0000000-0000-0000-0000-000000000001','2026-04-01','00000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000005',1500000,1420000,'SAR','completed',NULL),
  ('c4000000-0000-0000-0000-000000000003','c0000000-0000-0000-0000-0000000000002','b0000000-0000-0000-0000-000000000001','2026-05-01','00000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000005',1800000,NULL,'SAR','active','Q3 order expected end of May.'),
  -- SABIC targets
  ('c4000000-0000-0000-0000-000000000004','c0000000-0000-0000-0000-0000000000002','b0000000-0000-0000-0000-000000000002','2026-03-01','00000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000005',4200000,4350000,'SAR','completed','SABIC framework performing above plan.'),
  ('c4000000-0000-0000-0000-000000000005','c0000000-0000-0000-0000-0000000000002','b0000000-0000-0000-0000-000000000002','2026-04-01','00000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000005',4500000,4200000,'SAR','completed',NULL),
  ('c4000000-0000-0000-0000-000000000006','c0000000-0000-0000-0000-0000000000002','b0000000-0000-0000-0000-000000000002','2026-05-01','00000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000005',5000000,NULL,'SAR','active','Q2 extension negotiation in progress.'),
  -- Arabian Pipe Company targets
  ('c4000000-0000-0000-0000-000000000007','c0000000-0000-0000-0000-0000000000002','b0000000-0000-0000-0000-000000000005','2026-04-01','00000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000005',2800000,2950000,'SAR','completed','APC contract won April. First delivery complete.'),
  ('c4000000-0000-0000-0000-000000000008','c0000000-0000-0000-0000-0000000000002','b0000000-0000-0000-0000-000000000005','2026-05-01','00000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000005',2800000,NULL,'SAR','active',NULL),
  -- Tasnee targets
  ('c4000000-0000-0000-0000-000000000009','c0000000-0000-0000-0000-0000000000002','b0000000-0000-0000-0000-000000000006','2026-05-01','00000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000006',3500000,NULL,'SAR','active','Contract expected to close by June. Major deal.'),
  ('c4000000-0000-0000-0000-000000000010','c0000000-0000-0000-0000-0000000000002','b0000000-0000-0000-0000-000000000006','2026-06-01','00000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000006',4500000,NULL,'SAR','active',NULL)
...
INSERT INTO public.product_group_targets (
  ...
  ('94000000-0000-0000-0000-000000000001','c0000000-0000-0000-0000-0000000000002','e0000000-0000-0000-0000-000000000001','2026-01-01','00000000-0000-0000-0000-000000000004','00000000-0000-0000-0000-000000000003',4500000,4750000,550,580,'SAR','completed','Strong CPVC sales — Aramco deal contributed.'),
  ('94000000-0000-0000-0000-000000000002','c0000000-0000-0000-0000-0000000000002','e0000000-0000-0000-0000-000000000001','2026-02-01','00000000-0000-0000-0000-000000000004','00000000-0000-0000-0000-000000000003',4800000,4620000,580,555,'SAR','completed',NULL),
  ('94000000-0000-0000-0000-000000000003','c0000000-0000-0000-0000-0000000000002','e0000000-0000-0000-0000-000000000001','2026-03-01','00000000-0000-0000-0000-000000000004','00000000-0000-0000-0000-000000000003',5000000,4850000,600,580,'SAR','completed',NULL),
  ('94000000-0000-0000-0000-000000000004','c0000000-0000-0000-0000-0000000000002','e0000000-0000-0000-0000-000000000001','2026-04-01','00000000-0000-0000-0000-000000000004','00000000-0000-0000-0000-000000000003',5500000,5120000,650,610,'SAR','completed',NULL),
  ('94000000-0000-0000-0000-000000000005','c0000000-0000-0000-0000-0000000000002','e0000000-0000-0000-0000-000000000001','2026-05-01','00000000-0000-0000-0000-000000000004','00000000-0000-0000-0000-000000000003',7000000,NULL,820,NULL,'SAR','active','Tasnee close expected to push May to record.'),
  -- JSLIT group targets (Jan–May)
  ('94000000-0000-0000-0000-000000000006','c0000000-0000-0000-0000-0000000000002','e0000000-0000-0000-0000-000000000002','2026-01-01','00000000-0000-0000-0000-000000000004','00000000-0000-0000-0000-000000000003',5000000,4990000,850,845,'SAR','completed',NULL),
  ('94000000-0000-0000-0000-000000000007','c0000000-0000-0000-0000-0000000000002','e0000000-0000-0000-0000-000000000002','2026-02-01','00000000-0000-0000-0000-000000000004','00000000-0000-0000-0000-000000000003',5400000,5360000,900,893,'SAR','completed','SABIC framework driving slitted coil volumes.'),
  ('94000000-0000-0000-0000-000000000008','c0000000-0000-0000-0000-0000000000002','e0000000-0000-0000-0000-000000000002','2026-03-01','00000000-0000-0000-0000-000000000004','00000000-0000-0000-0000-000000000003',5800000,5800000,970,970,'SAR','completed','Exactly on target.'),
  ('94000000-0000-0000-0000-000000000009','c0000000-0000-0000-0000-0000000000002','e0000000-0000-0000-0000-000000000002','2026-04-01','00000000-0000-0000-0000-000000000004','00000000-0000-0000-0000-000000000003',6500000,6555000,1080,1090,'SAR','completed','APC contract: 1,450TO phased delivery started.'),
  ('94000000-0000-0000-0000-000000000010','c0000000-0000-0000-0000-0000000000002','e0000000-0000-0000-0000-000000000002','2026-05-01','00000000-0000-0000-0000-000000000004','00000000-0000-0000-0000-000000000003',6500000,NULL,1080,NULL,'SAR','active','SABIC Q2 extension in negotiation.')
